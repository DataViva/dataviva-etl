...
class EmpregoAggs(unittest.TestCase):
    ...
    def test_BRA_ID(self):
        ...
        total+=runCountQuery('checkBRA_ID', 'rais_yb', sql,cursor)   
        ...
        #total+=runCountQuery('checkBRA_ID', 'rais_ybi', sql,cursor) 
        ...
        #total+=runCountQuery('checkBRA_ID', 'rais_ybo', sql,cursor) 
    ...
    def test_BRA_IDPR(self):    
        ...
        total+=runCountQuery('checkBRA_IDPR', 'rais_yb', sql,cursor) 
        ...
        #total+=runCountQuery('checkBRA_IDPR', 'rais_ybi', sql,cursor) 
        ...
        #total+=runCountQuery('checkBRA_IDPR', 'rais_ybo', sql,cursor) 
    ...
    def test_CNAE_ID(self):
        ...
        for aggs in aggsP:    
            ...
            total+=runCountQuery('checkcnae_ID', 'rais_yi:'+str(aggs[0])+":"+str(aggs[1]), sql,cursor,count=True) 
            ...
            total+=runCountQuery('checkcnae_ID', 'rais_ybi:'+str(aggs[0])+":"+str(aggs[1]), sql,cursor,count=True) 
            ...
            total+=runCountQuery('checkcnae_ID', 'rais_ybio:'+str(aggs[0])+":"+str(aggs[1]), sql,cursor,count=True) 
            ...
            total+=runCountQuery('checkcnae_ID', 'rais_yio'+str(aggs[0])+":"+str(aggs[1]), sql,cursor,count=True) 
    ...
    def test_CBO_ID(self):
        ...
        for aggs in aggsP: 
            ...
            total+=runCountQuery('checkCBO_ID', 'rais_yo:'+str(aggs[0])+":"+str(aggs[1]), sql,cursor,count=True)     
            ...
            total+=runCountQuery('checkCBO_ID', 'rais_ybo:'+str(aggs[0])+":"+str(aggs[1]), sql,cursor,count=True) 
            ...
            total+=runCountQuery('checkCBO_ID', 'rais_ybio:'+str(aggs[0])+":"+str(aggs[1]), sql,cursor,count=True) 
            ...
            total+=runCountQuery('checkCBO_ID', 'rais_yio:'+str(aggs[0])+":"+str(aggs[1]), sql,cursor,count=True) 
        ...
        total+=runCountQuery('checkCBO_ID', 'rais_ybo x rais_yo', sql,cursor,count=True) 
        ...
        sql="SELECT count(*) FROM rais_yo as b where b.cbo_id_len=1 and b.wage <> \
            ...
            group by left(cbo_id,1),year)"   
        total+=runCountQuery('checkCBO_ID', 'rais_ybio x rais_yo', sql,cursor,count=True) 
