...
def checkValUSD():
    ...
    runCountQuery('checkValUSD', 'secex_yb', sql) 
    
    sql="select * from secex_ybp where val_usd is null;"
    runCountQuery('checkValUSD', 'secex_ybp', sql) 
    
    sql="select * from secex_ybpw where val_usd is null;"
    runCountQuery('checkValUSD', 'secex_ybpw', sql) 
    
    sql="select * from secex_ybw where val_usd is null;"
    runCountQuery('checkValUSD', 'secex_ybw', sql) 
    
    sql="select * from secex_yp where val_usd is null;"
    runCountQuery('checkValUSD', 'secex_yp', sql) 
...
def checkGrowth():  
    ...
    for vals in years:
        ...
        runCountQuery('checkGrowth_pct', "secex_yb", sql)
        ...
        runCountQuery('checkGrowth', "secex_yw", sql)
        ...
        runCountQuery('checkGrowth', "secex_yp", sql)
        ...
        runCountQuery('checkGrowth', "secex_ybp", sql)    
        ...
        runCountQuery('checkGrowth', "secex_ybw", sql)      
