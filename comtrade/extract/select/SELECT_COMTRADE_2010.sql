...
/* 
    ...
    "select * from COMTRADE_2010_STEP1" > comtrade_2010.csv
*/

-- Com os dados gerados no paso anterior, execute o script (format_raw_data.py)
-- para calcular o PCI, ECI e a tabela YPW para o ano 2010. Disponível em:
...
load data local infile '/comtrade/2010/comtrade_eci.tsv'
...
load data local infile '/comtrade/2010/comtrade_pci.tsv'
...
load data local infile '/comtrade/2010/comtrade_ypw.tsv'
