...
/* 
    ...
    "select * from COMTRADE_2011_STEP1" > comtrade_2011.csv
*/

-- Com os dados gerados no paso anterior, execute o script (format_raw_data.py)
-- para calcular o PCI, ECI e a tabela YPW para o ano 2011. Disponível em:
...
load data local infile '/comtrade/2011/comtrade_eci.tsv'
...
load data local infile '/comtrade/2011/comtrade_pci.tsv'
...
load data local infile '/comtrade/2011/comtrade_ypw.tsv'
