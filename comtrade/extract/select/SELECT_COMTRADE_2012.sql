...
/* 
    ...
    "select * from COMTRADE_2012_STEP1" > comtrade_2012.csv
*/

-- Com os dados gerados no paso anterior, execute o script (format_raw_data.py)
-- para calcular o PCI, ECI e a tabela YPW para o ano 2012. Disponível em:
...
load data local infile '/comtrade/2012/comtrade_eci.tsv'
...
load data local infile '/comtrade/2012/comtrade_pci.tsv'
...
load data local infile '/comtrade/2012/comtrade_ypw.tsv'
