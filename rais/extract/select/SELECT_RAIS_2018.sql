...
/*
    ...
    das transformações.
*/
drop table if exists RAIS_2018_STEP1;

create table RAIS_2018_STEP1 (
    PIS varchar(11),
...
update RAIS_2018_STEP1 set SEXO = if(SEXO = 2, 0, SEXO);

-- Recodificação da variável RACA_COR  
update RAIS_2018_STEP1 set RACA_COR = if(RACA_COR = -1 or RACA_COR = 9 or RACA_COR = 99, -1, right(RACA_COR,1));
...
update RAIS_2018_STEP1 left join escolaridade 
on RAIS_2018_STEP1.GR_INSTRUCAO = escolaridade.FONTE
set RAIS_2018_STEP1.GR_INSTRUCAO = escolaridade.ESCOLARIDADE;
...
update RAIS_2018_STEP1 left join tamestab 
on RAIS_2018_STEP1.TAM_ESTAB = tamestab.FONTE
set RAIS_2018_STEP1.TAM_ESTAB = tamestab.TAM_ESTAB;
...
/*
    A tabela RAIS_2018_STEP3 é criada para o passo 3
    das transformações.
*/
...
update RAIS_2018_STEP3 left join MUNICIPIOS_2017
on RAIS_2018_STEP3.MUNICIPIO = MUNICIPIOS_2017.CO_MUN_6
set RAIS_2018_STEP3.REGIAO = MUNICIPIOS_2017.CO_REGIAO,
    RAIS_2018_STEP3.UF = MUNICIPIOS_2017.CO_UF,
    RAIS_2018_STEP3.MESORREGIAO = MUNICIPIOS_2017.CO_MESORREGIAO,
    RAIS_2018_STEP3.MICRORREGIAO = MUNICIPIOS_2017.CO_MICRORREGIAO,
