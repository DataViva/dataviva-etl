...
create table RAIS_2009_STEP1 SELECT PIS, IDENTIFICAD, MUNICIPIO_FONTE as MUNICIPIO, GENERO as SEXO, 
        ...
        FROM RAIS_2009 WHERE CAUSA_DESLI_FONTE='00';


-- STEP 2: Transformação e Padronização das variáveis selecionadas no STEP 1:

create table RAIS_2009_STEP2 select * from RAIS_2009_STEP1;
...
update RAIS_2009_STEP2 left join genero 
on RAIS_2009_STEP2.SEXO = genero.FONTE
set RAIS_2009_STEP2.SEXO = genero.SEXO;
...
update RAIS_2009_STEP2 left join etnia 
on RAIS_2009_STEP2.ETNIA = etnia.FONTE
set RAIS_2009_STEP2.ETNIA = etnia.ETNIA;

drop table etnia;

/* Renomeando a variável CBO2002 */

update RAIS_2009_STEP2 set CBO2002 = left(CBO2002,4);

update RAIS_2009_STEP2 set CBO2002 = 
...
update RAIS_2009_STEP2 left join escolaridade 
on RAIS_2009_STEP2.ESCOLARIDADE = escolaridade.FONTE
set RAIS_2009_STEP2.ESCOLARIDADE = escolaridade.ESCOLARIDADE;
...
update RAIS_2009_STEP2 left join tamestab 
on RAIS_2009_STEP2.TAM_ESTAB = tamestab.FONTE
set RAIS_2009_STEP2.TAM_ESTAB = tamestab.TAM_ESTAB;
...
alter table RAIS_2009_STEP2 add NATUR_JUR2 int(1);

update RAIS_2009_STEP2 left join natjur 
on RAIS_2009_STEP2.NATUR_JUR = natjur.FONTE
set RAIS_2009_STEP2.NATUR_JUR2 = natjur.NATUR_JUR;

alter table RAIS_2009_STEP2 drop NATUR_JUR;
alter table RAIS_2009_STEP2 change NATUR_JUR2 NATUR_JUR int(2);

update RAIS_2009_STEP2 set NATUR_JUR = if(NATUR_JUR is null,-1,NATUR_JUR);

drop table if exists natjur;

/* *** Transformando a variável REMUNERACAO em variável numérica *** */

update RAIS_2009_STEP2 set REMUNERACAO = replace(REMUNERACAO,',','.');

alter table RAIS_2009_STEP2 change REMUNERACAO REMUNERACAO double(14,2);

-- STEP 3: Transformação e Padronização das variáveis selecionadas no STEP 2:

create table RAIS_2009_STEP3 select * from RAIS_2009_STEP2;
