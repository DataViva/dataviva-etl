...
/*
    A tabela RAIS_2019_STEP4 é criada para o passo 4 das
    transformações. Os dados são preparados para inserção no
    banco Amazon Redshift.
*/

drop table if exists RAIS_2019_STEP4;

create table RAIS_2019_STEP4 (
    year integer,
    region varchar(1),
...
select 2019, REGIAO, MESORREGIAO, MICRORREGIAO, UF, MUNICIPIO, OCUP_2002, GRUPO_OCUPACAO,
...
from RAIS_2019_STEP3;

drop table if exists RAIS_2019_STEP1, RAIS_2019_STEP2, RAIS_2019_STEP3;