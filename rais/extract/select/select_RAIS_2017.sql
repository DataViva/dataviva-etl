...
/*
    ...
    das transformações.
*/
drop table if exists RAIS_2017_STEP1;

create table RAIS_2017_STEP1 (
    PIS varchar(11),
...
update RAIS_2017_STEP1 set SEXO = if(SEXO = 2, 0, SEXO);

-- Recodificação da variável RACA_COR  
update RAIS_2017_STEP1 set RACA_COR = if(RACA_COR = -1 or RACA_COR = 9 or RACA_COR = 99, -1, right(RACA_COR,1));
...
update RAIS_2017_STEP1 left join escolaridade 
on RAIS_2017_STEP1.GR_INSTRUCAO = escolaridade.FONTE
set RAIS_2017_STEP1.GR_INSTRUCAO = escolaridade.ESCOLARIDADE;
...
update RAIS_2017_STEP1 left join tamestab 
on RAIS_2017_STEP1.TAM_ESTAB = tamestab.FONTE
set RAIS_2017_STEP1.TAM_ESTAB = tamestab.TAM_ESTAB;
...
*/
update RAIS_2017_STEP1 set OCUP_2002 = 
   if(OCUP_2002 IN ('0101', '0102', '0103', '0201', '0202', '0203', '0211', '0212',
  '0301', '0302', '0303', '0311', '0312', '0000'),'-1', OCUP_2002);

/*
    A tabela RAIS_2017_STEP2 é criada para o passo 2
    das transformações.
*/
drop table if exists RAIS_2017_STEP2;

create table RAIS_2017_STEP2 select * from RAIS_2017_STEP1;
...
load data local infile '/home/dev1/Desktop/ETL_2017/Merge_Natureza_Juridica_Total_2016.csv'
into table natjur
...
update RAIS_2017_STEP2 left join natjur 
on RAIS_2017_STEP2.NATUR_JUR = natjur.FONTE
set RAIS_2017_STEP2.NATUR_JUR = natjur.NATUR_JUR;
...
load data local infile '/home/dev1/Desktop/ETL_2017/estrutura_CNAE.txt'
into table cnae
fields terminated by ';'
lines terminated by '\n'
ignore 1 lines;

update RAIS_2017_STEP2 left join cnae
on RAIS_2017_STEP2.CLAS_CNAE_20 = cnae.CLASSE
set RAIS_2017_STEP2.DIVISAO = cnae.DIVISAO, RAIS_2017_STEP2.SECAO = cnae.SECAO;
...
*/
update RAIS_2017_STEP2 set GRUPO_OCUPACAO = left(OCUP_2002, 1);

/*
    A tabela RAIS_2017_STEP3 é criada para o passo 3
    das transformações.
*/
drop table if exists RAIS_2017_STEP3;

create table RAIS_2017_STEP3 select * from RAIS_2017_STEP2;
...
alter table RAIS_2017_STEP3 add (REGIAO varchar(1), UF varchar(2), 
                                 MESORREGIAO varchar(4), MICRORREGIAO varchar(5));

update RAIS_2017_STEP3 left join MUNICIPIOS_2017
on RAIS_2017_STEP3.MUNICIPIO = MUNICIPIOS_2017.CO_MUN_6
set RAIS_2017_STEP3.REGIAO = MUNICIPIOS_2017.CO_REGIAO,
    RAIS_2017_STEP3.UF = MUNICIPIOS_2017.CO_UF,
    RAIS_2017_STEP3.MESORREGIAO = MUNICIPIOS_2017.CO_MESORREGIAO,
    RAIS_2017_STEP3.MICRORREGIAO = MUNICIPIOS_2017.CO_MICRORREGIAO,
    RAIS_2017_STEP3.MUNICIPIO = MUNICIPIOS_2017.CO_MUN_7;

drop table MUNICIPIOS_2017; 

/*
    A tabela RAIS_2017_STEP4 é criada para o passo 4 das
    transformações. Os dados são preparados para inserção no
    banco Amazon Redshift.
*/
drop table if exists RAIS_2017_STEP4;

create table RAIS_2017_STEP4 (
    year integer,
    region varchar(1),
...
select 2017, REGIAO, MESORREGIAO, MICRORREGIAO, UF, MUNICIPIO, OCUP_2002, GRUPO_OCUPACAO,
