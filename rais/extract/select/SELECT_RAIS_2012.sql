...
update RAIS_2012 set EMP_31_12=right(EMP_31_12,1);

create table RAIS_2012_STEP1 SELECT PIS, IDENTIFICAD, MUNICIPIO, SEXO, IDADE, RACA_COR as ETNIA, 
        ...
        FROM RAIS_2012 WHERE EMP_31_12='1';

-- STEP 2: Transformação e Padronização das variáveis selecionadas no STEP 1:

drop table RAIS_2012_STEP2;
create table RAIS_2012_STEP2 select * from RAIS_2012_STEP1;

/* Recodificando a variável SEXO */

update RAIS_2012_STEP2 set SEXO=right(SEXO,1);

create table genero(FONTE int(1), SEXO int(1));
insert into genero values(1,1),(2,0);

update RAIS_2012_STEP2 left join genero 
on RAIS_2012_STEP2.SEXO = genero.FONTE
set RAIS_2012_STEP2.SEXO = genero.SEXO;
...
update RAIS_2012_STEP2 left join etnia 
on RAIS_2012_STEP2.ETNIA = etnia.FONTE
set RAIS_2012_STEP2.ETNIA = etnia.ETNIA;

drop table etnia;

/* Renomeando a variável CBO2002 */

update RAIS_2012_STEP2 set CBO2002 = left(CBO2002,4);

update RAIS_2012_STEP2 set CBO2002 = 
...
update RAIS_2012_STEP2 set ESCOLARIDADE=right(ESCOLARIDADE,2);
...
update RAIS_2012_STEP2 left join escolaridade 
on RAIS_2012_STEP2.ESCOLARIDADE = escolaridade.FONTE
set RAIS_2012_STEP2.ESCOLARIDADE = escolaridade.ESCOLARIDADE;
...
update RAIS_2012_STEP2 set TAM_ESTAB=right(TAM_ESTAB,2);
...
update RAIS_2012_STEP2 left join tamestab 
on RAIS_2012_STEP2.TAM_ESTAB = tamestab.FONTE
set RAIS_2012_STEP2.TAM_ESTAB = tamestab.TAM_ESTAB;
...
update RAIS_2012_STEP2 left join natjur 
on RAIS_2012_STEP2.NATUR_JUR = natjur.FONTE
set RAIS_2012_STEP2.NATUR_JUR = natjur.NATUR_JUR;

drop table if exists natjur;

/* *** Transformando a variável REMUNERACAO em variável numérica *** */

update RAIS_2012_STEP2 set REMUNERACAO = replace(REMUNERACAO,',','.');

alter table RAIS_2012_STEP2 change REMUNERACAO REMUNERACAO double(14,2);

/* *** Transformando a variável IDADE em variável numérica *** */

alter table RAIS_2012_STEP2 change IDADE IDADE int(3);

-- STEP 3: Transformação e Padronização das variáveis selecionadas no STEP 2:

create table RAIS_2012_STEP3 select * from RAIS_2012_STEP2;
