...
/*
    A tabela RAIS_2020_STEP2 é criada para o passo 2
    das transformações.
*/
drop table if exists RAIS_2020_STEP2;

create table RAIS_2020_STEP2 select * from RAIS_2020_STEP1;
...
update RAIS_2020_STEP2 left join natjur 
on RAIS_2020_STEP2.NATUR_JUR = natjur.FONTE
set RAIS_2020_STEP2.NATUR_JUR = natjur.NATUR_JUR;
...
update RAIS_2020_STEP2 left join cnae
on RAIS_2020_STEP2.CLAS_CNAE_20 = cnae.CLASSE
set RAIS_2020_STEP2.DIVISAO = cnae.DIVISAO, RAIS_2020_STEP2.SECAO = cnae.SECAO;
...
/*
    A tabela RAIS_2020_STEP4 é criada para o passo 4 das
    transformações. Os dados são preparados para inserção no
    banco Amazon Redshift.
*/

drop table if exists RAIS_2020_STEP4;

create table RAIS_2020_STEP4 (
    year integer,
    region varchar(1),
...
select 2020, REGIAO, MESORREGIAO, MICRORREGIAO, UF, MUNICIPIO, OCUP_2002, GRUPO_OCUPACAO,
...
from RAIS_2020_STEP3;

drop table if exists RAIS_2020_STEP1, RAIS_2020_STEP2, RAIS_2020_STEP3;