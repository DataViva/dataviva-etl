...
CREATE INDEX index_municipio ON dataviva_raw.RAIS_2018 (MUNICIPIO);
CREATE INDEX index_cnae ON dataviva_raw.RAIS_2018 (CLAS_CNAE_20);
CREATE INDEX index_cbo ON dataviva_raw.RAIS_2018 (OCUP_2002);
CREATE INDEX index_emp3112 ON dataviva_raw.RAIS_2018 (EMP_31_12);
CREATE INDEX index_mun_cnae_cbo_emp ON dataviva_raw.RAIS_2018 (MUNICIPIO, CLAS_CNAE_20, OCUP_2002, EMP_31_12);