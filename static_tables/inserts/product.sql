...
(select bra_id from dataviva.secex_ymbp where year = '2014' and month = '0' and bra_id_len = '9' and hs_id = dataviva.secex_ymp.hs_id order by export_val desc limit 1) as Top_Municipality_Export,
...
(select bra_id from dataviva.secex_ymbp where year = '2014' and month = '0' and bra_id_len = '9' and hs_id = dataviva.secex_ymp.hs_id order by import_val desc limit 1) as Top_Municipality_Import,
