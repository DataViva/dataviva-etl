...
select CO_OCDE,count(*) from IES_2012_ALUNO_STEP2 group by CO_OCDE;
select CO_OCDE,count(*) from IES_2012_CURSO_STEP1 group by CO_OCDE;
select * from IES_2012_ALUNO_STEP2;
...
select CO_MUNICIPIO_NASCIMENTO, count(*) from IES_2012_ALUNO_STEP2 group by CO_MUNICIPIO_NASCIMENTO;
...
select CO_TURNO_ALUNO, count(*) from IES_2012_ALUNO_STEP2 group by CO_TURNO_ALUNO;

update IES_2012_ALUNO_STEP2 set CO_TURNO_ALUNO = if(CO_TURNO_ALUNO = '        ', '-1', CO_TURNO_ALUNO);

-- Codigo do Municipio IES

select CO_MUNICIPIO, count(*) from IES_2012_ALUNO_STEP2 group by CO_MUNICIPIO;

update IES_2012_ALUNO_STEP2 set CO_MUNICIPIO = if(CO_MUNICIPIO = '        ', '-1', CO_MUNICIPIO);

-- Codigo OCDE

select CO_OCDE, count(*) from IES_2012_ALUNO_STEP1 group by CO_OCDE;
update IES_2012_ALUNO_STEP2 set CO_OCDE = if(CO_OCDE = '            ', '-1', CO_OCDE);

-- Codigo local de oferta

select CO_LOCAL_OFERTA_IES, count(*) from IES_2012_ALUNO_STEP2 group by CO_LOCAL_OFERTA_IES;
...
select CO_ORGANIZACAO_ACADEMICA, count(*) from IES_2012_ALUNO_STEP2 group by CO_ORGANIZACAO_ACADEMICA;
...
select * from IES_2012_DOCENTE_STEP2;
...
select CO_IES, count(*) from IES_2012_DOCENTE_STEP2 group by CO_IES;

-- Categoria Administrativa
update IES_2012_DOCENTE_STEP2 set CO_CATEGORIA_ADMINISTRATIVA = 
if(CO_CATEGORIA_ADMINISTRATIVA = '       7', '       6', CO_CATEGORIA_ADMINISTRATIVA);

select CO_CATEGORIA_ADMINISTRATIVA, count(*) from IES_2012_DOCENTE_STEP2 group by CO_CATEGORIA_ADMINISTRATIVA;

-- Organização Acadêmica
update IES_2012_DOCENTE_STEP2 set CO_ORGANIZACAO_ACADEMICA = 
if(CO_ORGANIZACAO_ACADEMICA = '       5', '       4', CO_ORGANIZACAO_ACADEMICA);

select CO_ORGANIZACAO_ACADEMICA, count(*) from IES_2012_DOCENTE_STEP2 group by CO_ORGANIZACAO_ACADEMICA;

select CO_DOCENTE, count(*) from IES_2012_DOCENTE_STEP2 group by CO_DOCENTE;
select CO_SITUACAO_DOCENTE, count(*) from IES_2012_DOCENTE_STEP2 group by CO_SITUACAO_DOCENTE;
select CO_ESCOLARIDADE_DOCENTE, count(*) from IES_2012_DOCENTE_STEP2 group by CO_ESCOLARIDADE_DOCENTE;
...
select CO_REGIME_TRABALHO, count(*) from IES_2012_DOCENTE_STEP2 group by CO_REGIME_TRABALHO;


select IN_SEXO_DOCENTE, count(*) from IES_2012_DOCENTE_STEP2 group by IN_SEXO_DOCENTE;
select NU_IDADE_DOCENTE, count(*) from IES_2012_DOCENTE_STEP2 group by NU_IDADE_DOCENTE;
...
select CO_COR_RACA_DOCENTE, count(*) from IES_2012_DOCENTE_STEP2 group by CO_COR_RACA_DOCENTE;

-- UF NASCIMENTO
update IES_2012_DOCENTE_STEP2 set CO_UF_NASCIMENTO = 
if(CO_UF_NASCIMENTO = '        ', '-1', CO_UF_NASCIMENTO);

select CO_UF_NASCIMENTO, count(*) from IES_2012_DOCENTE_STEP2 group by CO_UF_NASCIMENTO;
...
select CO_MUNICIPIO_NASCIMENTO, count(*) from IES_2012_DOCENTE_STEP2 group by CO_MUNICIPIO_NASCIMENTO;

-- ATUA EM PESQUISA
update IES_2012_DOCENTE_STEP2 set IN_ATU_PESQUISA = 
if(IN_ATU_PESQUISA = '        ', '-1', IN_ATU_PESQUISA);

select IN_ATU_PESQUISA, count(*) from IES_2012_DOCENTE_STEP2 group by IN_ATU_PESQUISA;

-- ATUA POS PRESENCIAL
update IES_2012_DOCENTE_STEP2 set IN_ATU_POS_PRESENCIAL = 
if(IN_ATU_POS_PRESENCIAL = '        ', '-1', IN_ATU_POS_PRESENCIAL);

select IN_ATU_POS_PRESENCIAL, count(*) from IES_2012_DOCENTE_STEP2 group by IN_ATU_POS_PRESENCIAL;


select CO_MANTENEDORA, count(*) from IES_2012_DOCENTE_STEP2 group by CO_MANTENEDORA;
select CO_MUNICIPIO_IES, count(*) from IES_2012_DOCENTE_STEP2 group by CO_MUNICIPIO_IES;
select CO_UF, count(*) from IES_2012_DOCENTE_STEP2 group by CO_UF;
select QT_TEC_TOTAL, count(*) from IES_2012_DOCENTE_STEP2 group by QT_TEC_TOTAL;
select IN_REFERENTE, count(*) from IES_2012_DOCENTE_STEP2 group by IN_REFERENTE;
