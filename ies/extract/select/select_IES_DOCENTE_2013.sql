...
alter table IES_2013_DOCENTE_STEP3 change CO_IES CO_IES int(8);
select distinct CO_IES from IES_2013_DOCENTE_STEP3;

alter table IES_2013_DOCENTE_STEP3 change CO_CATEGORIA_ADMINISTRATIVA CO_CATEGORIA_ADMINISTRATIVA int(8);
select distinct CO_CATEGORIA_ADMINISTRATIVA from IES_2013_DOCENTE_STEP3;

alter table IES_2013_DOCENTE_STEP3 change CO_ORGANIZACAO_ACADEMICA CO_ORGANIZACAO_ACADEMICA int(8);
select distinct CO_ORGANIZACAO_ACADEMICA from IES_2013_DOCENTE_STEP3;

alter table IES_2013_DOCENTE_STEP3 change CO_SITUACAO_DOCENTE CO_SITUACAO_DOCENTE int(8);
select distinct CO_SITUACAO_DOCENTE from IES_2013_DOCENTE_STEP3;

alter table IES_2013_DOCENTE_STEP3 change CO_ESCOLARIDADE_DOCENTE CO_ESCOLARIDADE_DOCENTE int(8);
select distinct CO_ESCOLARIDADE_DOCENTE from IES_2013_DOCENTE_STEP3;

alter table IES_2013_DOCENTE_STEP3 change CO_REGIME_TRABALHO CO_REGIME_TRABALHO int(8);
select distinct CO_REGIME_TRABALHO from IES_2013_DOCENTE_STEP3;

alter table IES_2013_DOCENTE_STEP3 change IN_SEXO_DOCENTE IN_SEXO_DOCENTE int(8);
select distinct IN_SEXO_DOCENTE from IES_2013_DOCENTE_STEP3;

alter table IES_2013_DOCENTE_STEP3 change NU_IDADE_DOCENTE NU_IDADE_DOCENTE int(8);
select distinct NU_IDADE_DOCENTE from IES_2013_DOCENTE_STEP3;

alter table IES_2013_DOCENTE_STEP3 change CO_COR_RACA_DOCENTE CO_COR_RACA_DOCENTE int(8);
select distinct CO_COR_RACA_DOCENTE from IES_2013_DOCENTE_STEP3;

alter table IES_2013_DOCENTE_STEP3 change CO_UF_NASCIMENTO CO_UF_NASCIMENTO int(8);
select distinct CO_UF_NASCIMENTO from IES_2013_DOCENTE_STEP3;

alter table IES_2013_DOCENTE_STEP3 change CO_MUNICIPIO_NASCIMENTO CO_MUNICIPIO_NASCIMENTO int(8);
select distinct CO_MUNICIPIO_NASCIMENTO from IES_2013_DOCENTE_STEP3;

alter table IES_2013_DOCENTE_STEP3 change IN_ATU_PESQUISA IN_ATU_PESQUISA int(8);
select distinct IN_ATU_PESQUISA from IES_2013_DOCENTE_STEP3;

alter table IES_2013_DOCENTE_STEP3 change IN_ATU_POS_PRESENCIAL IN_ATU_POS_PRESENCIAL int(8);
select distinct IN_ATU_POS_PRESENCIAL from IES_2013_DOCENTE_STEP3;

alter table IES_2013_DOCENTE_STEP3 change CO_MUNICIPIO_IES CO_MUNICIPIO_IES int(8);
select distinct CO_MUNICIPIO_IES from IES_2013_DOCENTE_STEP3;

alter table IES_2013_DOCENTE_STEP3 change CO_UF CO_UF_IES int(8);
select distinct CO_UF_IES from IES_2013_DOCENTE_STEP3;

alter table IES_2013_DOCENTE_STEP3 change QT_TEC_TOTAL QT_TEC_TOTAL int(8);
select distinct QT_TEC_TOTAL from IES_2013_DOCENTE_STEP3;

alter table IES_2013_DOCENTE_STEP3 change IN_REFERENTE IN_REFERENTE int(8);
select distinct IN_REFERENTE from IES_2013_DOCENTE_STEP3;

alter table IES_2013_DOCENTE_STEP3 change VL_RECEITA_PROPRIA VL_RECEITA_PROPRIA double(14,2);
select distinct VL_RECEITA_PROPRIA from IES_2013_DOCENTE_STEP3;

alter table IES_2013_DOCENTE_STEP3 change VL_TRANSFERENCIA VL_TRANSFERENCIA double(14,2);
select distinct VL_TRANSFERENCIA from IES_2013_DOCENTE_STEP3;

alter table IES_2013_DOCENTE_STEP3 change VL_OUTRA_RECEITA VL_OUTRA_RECEITA double(14,2);
select distinct VL_OUTRA_RECEITA from IES_2013_DOCENTE_STEP3;

alter table IES_2013_DOCENTE_STEP3 change VL_DES_PESSOAL_REM_DOCENTE VL_DES_PESSOAL_REM_DOCENTE double(14,2);
select distinct VL_DES_PESSOAL_REM_DOCENTE from IES_2013_DOCENTE_STEP3;

alter table IES_2013_DOCENTE_STEP3 change VL_DES_PESSOAL_REM_TECNICO VL_DES_PESSOAL_REM_TECNICO double(14,2);
select distinct VL_DES_PESSOAL_REM_TECNICO from IES_2013_DOCENTE_STEP3;

alter table IES_2013_DOCENTE_STEP3 change VL_DES_PESSOAL_ENCARGO VL_DES_PESSOAL_ENCARGO double(14,2);
select distinct VL_DES_PESSOAL_ENCARGO from IES_2013_DOCENTE_STEP3;

alter table IES_2013_DOCENTE_STEP3 change VL_DES_CUSTEIO VL_DES_CUSTEIO double(14,2);
select distinct VL_DES_CUSTEIO from IES_2013_DOCENTE_STEP3;

alter table IES_2013_DOCENTE_STEP3 change VL_DES_INVESTIMENTO VL_DES_INVESTIMENTO double(14,2);
select distinct VL_DES_INVESTIMENTO from IES_2013_DOCENTE_STEP3;

alter table IES_2013_DOCENTE_STEP3 change VL_DES_PESQUISA VL_DES_PESQUISA double(14,2);
select distinct VL_DES_PESQUISA from IES_2013_DOCENTE_STEP3;

alter table IES_2013_DOCENTE_STEP3 change VL_DES_OUTRAS VL_DES_OUTRAS decimal(20,2);
select distinct VL_DES_OUTRAS from IES_2013_DOCENTE_STEP3;
