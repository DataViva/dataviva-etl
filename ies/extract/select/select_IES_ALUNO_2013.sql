...
alter table IES_2013_ALUNO_STEP2 change CO_IES CO_IES int(8);
select distinct CO_IES from IES_2013_ALUNO_STEP2;

alter table IES_2013_ALUNO_STEP2 change CO_CATEGORIA_ADMINISTRATIVA CO_CATEGORIA_ADMINISTRATIVA int(8);
select distinct CO_CATEGORIA_ADMINISTRATIVA from IES_2013_ALUNO_STEP2;

alter table IES_2013_ALUNO_STEP2 change CO_ORGANIZACAO_ACADEMICA CO_ORGANIZACAO_ACADEMICA int(8);
select distinct CO_ORGANIZACAO_ACADEMICA from IES_2013_ALUNO_STEP2;

alter table IES_2013_ALUNO_STEP2 change CO_GRAU_ACADEMICO CO_GRAU_ACADEMICO int(8);
select distinct CO_GRAU_ACADEMICO from IES_2013_ALUNO_STEP2;

alter table IES_2013_ALUNO_STEP2 change CO_MODALIDADE_ENSINO CO_MODALIDADE_ENSINO int(8);
select distinct CO_MODALIDADE_ENSINO from IES_2013_ALUNO_STEP2;

alter table IES_2013_ALUNO_STEP2 change IN_CONCLUINTE IN_CONCLUINTE int(8);
select distinct IN_CONCLUINTE from IES_2013_ALUNO_STEP2;

alter table IES_2013_ALUNO_STEP2 change IN_INGRESSO IN_INGRESSO int(8);
select distinct IN_INGRESSO from IES_2013_ALUNO_STEP2;

alter table IES_2013_ALUNO_STEP2 change IN_SEXO_ALUNO IN_SEXO_ALUNO int(8);
select distinct IN_SEXO_ALUNO from IES_2013_ALUNO_STEP2;

alter table IES_2013_ALUNO_STEP2 change NU_IDADE_ALUNO NU_IDADE_ALUNO int(8);
select distinct NU_IDADE_ALUNO from IES_2013_ALUNO_STEP2;

alter table IES_2013_ALUNO_STEP2 change CO_COR_RACA_ALUNO CO_COR_RACA_ALUNO int(8);
select distinct CO_COR_RACA_ALUNO from IES_2013_ALUNO_STEP2;

alter table IES_2013_ALUNO_STEP2 change CO_UF_NASCIMENTO CO_UF_NASCIMENTO int(8);
select distinct CO_UF_NASCIMENTO from IES_2013_ALUNO_STEP2;

alter table IES_2013_ALUNO_STEP2 change CO_MUNICIPIO_NASCIMENTO CO_MUNICIPIO_NASCIMENTO int(8);
select distinct CO_MUNICIPIO_NASCIMENTO from IES_2013_ALUNO_STEP2;

alter table IES_2013_ALUNO_STEP2 change CO_TURNO_ALUNO CO_TURNO_ALUNO int(8);
select distinct CO_TURNO_ALUNO from IES_2013_ALUNO_STEP2;

alter table IES_2013_ALUNO_STEP2 change CO_MUNICIPIO CO_MUNICIPIO_IES int(8);
select distinct CO_MUNICIPIO_IES from IES_2013_ALUNO_STEP2;

alter table IES_2013_ALUNO_STEP2 change CO_LOCAL_OFERTA_IES CO_LOCAL_OFERTA_IES int(8);
select distinct CO_LOCAL_OFERTA_IES from IES_2013_ALUNO_STEP2;

alter table IES_2013_ALUNO_STEP2 change MES_INGRESSO MES_INGRESSO int(8);
select distinct MES_INGRESSO from IES_2013_ALUNO_STEP2;
