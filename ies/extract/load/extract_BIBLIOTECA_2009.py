...
def main(file_path):
    ...
    tuples = []
    dtype = {'CO_UNIDADE_FUNCIONAMENTO' : Numeric(8),'CO_BIBLIOTECA' : Numeric(8),'CO_TIPO_BIBLIOTECA' : Numeric(8),'IN_REDE_WIRELESS' : Numeric(8),'IN_CATALOGO_ONLINE' : Numeric(8),'QT_ASSENTO' : Numeric(8),'QT_EMPRESTIMO_DOMICILIAR' : Numeric(8),'QT_EMPRESTIMO_BIBLIOTECA' : Numeric(8),'QT_COMUTACAO' : Numeric(8),'QT_USUARIO_CAPACITADO' : Numeric(8),'QT_ACERVO' : Numeric(8)}
