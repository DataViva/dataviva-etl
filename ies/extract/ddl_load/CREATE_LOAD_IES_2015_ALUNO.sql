...
drop table if exists IES_2015_ALUNO;
create table IES_2015_ALUNO(
CO_IES varchar(8),
NO_IES varchar(200),
...
load data local infile 'H:/HEDU/Dados/2015/DADOS/DM_ALUNO.csv'
into table IES_2015_ALUNO
character set 'latin1'
fields terminated by '|'
lines terminated by '\n'
ignore 1 lines;

select count(*) from IES_2015_ALUNO;
select * from IES_2015_ALUNO;
