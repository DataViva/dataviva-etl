...
drop table if exists IES_2015_LOCAL_OFERTA_POLO;
create table IES_2015_LOCAL_OFERTA_POLO(
...
load data local infile 'H:/HEDU/Dados/2015/DADOS/DM_LOCAL_OFERTA.csv'
into table IES_2015_LOCAL_OFERTA_POLO
character set 'latin1'
fields terminated by '|'
lines terminated by '\n'
ignore 1 lines;

select count(*) from IES_2015_LOCAL_OFERTA_POLO;
select * from IES_2015_LOCAL_OFERTA_POLO;
