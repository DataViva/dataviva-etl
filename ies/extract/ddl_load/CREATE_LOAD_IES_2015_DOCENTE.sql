...
drop table if exists IES_2015_DOCENTE;
create table IES_2015_DOCENTE(
CO_IES varchar(8),
NO_IES varchar(200),
...
load data local infile 'H:/HEDU/Dados/2015/DADOS/DM_DOCENTE.csv'
into table IES_2015_DOCENTE
character set 'latin1'
fields terminated by '|'
lines terminated by '\n'
ignore 1 lines;

select * from IES_2015_DOCENTE;

select count(*) from IES_2015_DOCENTE;
