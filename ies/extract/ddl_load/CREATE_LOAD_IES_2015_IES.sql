...
drop table if exists IES_2015_IES;
create table IES_2015_IES(
CO_IES varchar(8),
NO_IES varchar(200),
SGL_IES varchar(20),
...
load data local infile 'H:/HEDU/Dados/2015/DADOS/DM_IES.csv'
into table IES_2015_IES
character set 'latin1'
fields terminated by '|'
lines terminated by '\n'
ignore 1 lines;

select count(*) from IES_2015_IES;
select * from IES_2015_IES;
