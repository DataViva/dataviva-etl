...
drop table if exists IES_2013_IES;
create table IES_2013_IES(
CO_IES varchar(8),
NO_IES varchar(200),
SGL_IES varchar(20),
...
VL_RECEITA_PROPRIA varchar(15),
VL_TRANSFERENCIA varchar(15),
VL_OUTRA_RECEITA varchar(15),
VL_DES_PESSOAL_REM_DOCENTE varchar(15),
VL_DES_PESSOAL_REM_TECNICO varchar(15),
VL_DES_PESSOAL_ENCARGO varchar(15),
VL_DES_CUSTEIO varchar(15),
VL_DES_INVESTIMENTO varchar(15),
VL_DES_PESQUISA varchar(15),
VL_DES_OUTRAS varchar(15)
);


load data local infile 'H:/HEDU/Dados/2013/Dados/DM_IES.csv'
into table IES_2013_IES
character set 'latin1'
fields terminated by '|'
lines terminated by '\n'
ignore 1 lines;

select * from IES_2013_IES;
