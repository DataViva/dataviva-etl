...
drop table if exists IES_2014_ALUNO;
create table IES_2014_ALUNO(
CO_IES varchar(8),
NO_IES varchar(200),
...
load data local infile 'H:/HEDU/Dados/2014/Dados/DM_ALUNO.csv'
into table IES_2014_ALUNO
character set 'latin1'
fields terminated by '|'
lines terminated by '\n'
ignore 1 lines;

select * from IES_2014_ALUNO;
