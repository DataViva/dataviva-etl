...
update SECEX_2017_IMP_STEP2 set MUN_IBGE = if(MUN_IBGE is NULL, CO_MUN_GEO, MUN_IBGE);
...
alter table SECEX_2017_IMP_STEP2 add (REGIAO varchar(1), UF varchar(2), MESORREGIAO varchar(4),MICRORREGIAO varchar(5));
...
set SECEX_2017_IMP_STEP2.REGIAO = MUNICIPIOS_2016.CO_REGIAO,
    SECEX_2017_IMP_STEP2.UF = MUNICIPIOS_2016.CO_UF,
...
update SECEX_2017_IMP_STEP3 set municipality = '' where municipality is null;
...
update SECEX_2017_IMP_STEP3 set region = '' where region is null;  
