...
select cnes, codufmun, cod_cep, cpf_cnpj, pf_pj, niv_dep, cnpj_man, regsaude, micr_reg, vinc_sus, esfera_a, retencao, tp_unid, niv_hier, tp_prest, av_acred, clasaval, av_pnass, gesprg1e, gesprg1m, gesprg2e,
...
create table ESTAB_2014_STEP2 select * from ESTAB_2014_STEP1;
