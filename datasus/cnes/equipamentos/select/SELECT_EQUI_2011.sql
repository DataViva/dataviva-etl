...
alter table EQUI_2011_STEP2 drop esfera_a;
...
alter table EQUI_2011_STEP2 drop retencao;
...
alter table EQUI_2011_STEP2 add niv_hier_2 varchar (2);

update EQUI_2011_STEP2 left join niv_hier 
on EQUI_2011_STEP2.niv_hier = niv_hier.fonte
set EQUI_2011_STEP2.niv_hier_2 = niv_hier.niv_hier;


select * from  EQUI_2011_STEP2 left join niv_hier  
on EQUI_2011_STEP2.niv_hier = niv_hier .fonte;

alter table EQUI_2011_STEP2 drop niv_hier;
...
alter table EQUI_2011_STEP2 drop competen;
...
alter table EQUI_2011_STEP2 add competen1 varchar(4);
update EQUI_2011_STEP2 set competen1='2011';        
