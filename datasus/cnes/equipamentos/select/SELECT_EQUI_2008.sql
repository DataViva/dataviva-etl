...
create table EQUI_2008_STEP2 select * from EQUI_2008_STEP1;

/* Renomeando a variável MUNICIPIO */

alter table EQUI_2008_STEP2 change codufmun codmun VARCHAR(6);

/*Aletrando codigos dos municipios satelites de Brasilia */ #conferir se as cidades foram substituidas

update EQUI_2008_STEP2 set codmun = 
...
alter table EQUI_2008_STEP2 drop regsaude; 
...
alter table EQUI_2008_STEP2 add retencao_2 varchar (2);

update EQUI_2008_STEP2 left join retencao 
on EQUI_2008_STEP2.retencao = retencao.fonte
set EQUI_2008_STEP2.retencao_2 = retencao.retencao;
...
alter table EQUI_2008_STEP2 drop competen;
...
alter table EQUI_2008_STEP2 add competen1 varchar(4);
update EQUI_2008_STEP2 set competen1='2008';
