...
alter table EQUI_2009_STEP2 drop regsaude; ##ainda não finalizado
...
update EQUI_2009_STEP2 left join regsaude 
on EQUI_2009_STEP2.codmun = regsaude.municipio
set EQUI_2009_STEP2.regsaude = regsaude.cod_regsaude;
...
alter table EQUI_2009_STEP2 drop esfera;
alter table EQUI_2009_STEP2 add esfera varchar(2);

update EQUI_2009_STEP2 left join esfera 
on EQUI_2009_STEP2.esfera_a = esfera.esfera_a
set EQUI_2009_STEP2.esfera = esfera.esfera;
...
update EQUI_2009_STEP2 left join retencao 
