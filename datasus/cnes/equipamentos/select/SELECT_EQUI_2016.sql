...
alter table EQUI_2016_STEP2 drop regsaude; 
...
alter table EQUI_2016_STEP2 add regsaude varchar(5);

update EQUI_2016_STEP2 left join regsaude 
on EQUI_2016_STEP2.codmun = regsaude.municipio
set EQUI_2016_STEP2.regsaude = regsaude.cod_regsaude;

/* Eliminar a variavel micr_reg */


alter table EQUI_2016_STEP2 drop micr_reg;
...
alter table EQUI_2016_STEP2 add esfera varchar(2);

update EQUI_2016_STEP2 left join esfera 
on EQUI_2016_STEP2.esfera_a = esfera.esfera_a
set EQUI_2016_STEP2.esfera = esfera.esfera;

alter table EQUI_2016_STEP2 drop esfera_a;
...
alter table EQUI_2016_STEP2 add retencao_2 varchar (2);

update EQUI_2016_STEP2 left join retencao 
on EQUI_2016_STEP2.retencao = retencao.fonte
set EQUI_2016_STEP2.retencao_2 = retencao.retencao;


alter table EQUI_2016_STEP2 drop retencao;
...
alter table EQUI_2016_STEP2 add niv_hier_2 varchar (2);

update EQUI_2016_STEP2 left join niv_hier 
on EQUI_2016_STEP2.niv_hier = niv_hier.fonte
set EQUI_2016_STEP2.niv_hier_2 = niv_hier.niv_hier;


select * from  EQUI_2016_STEP2 left join niv_hier  
on EQUI_2016_STEP2.niv_hier = niv_hier .fonte;


alter table EQUI_2016_STEP2 drop niv_hier;

/* ind_sus e ins_nsus na mesma variável */ 

alter table EQUI_2016_STEP2 drop ind_nsus; 

-- Criando tabela final - STEP3: 

drop table if exists EQUI_2016_STEP3;
create table EQUI_2016_STEP3 select * from EQUI_2016_STEP2;   