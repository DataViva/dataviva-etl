...
create table PROF_2008_STEP2 select * from PROF_2008_STEP1;

/* Renomeando a variável MUNICIPIO */

alter table PROF_2008_STEP2 change codufmun codmun VARCHAR(6);

/*Aletrando codigos dos municipios satelites de Brasilia */ #conferir se as cidades foram substituidas

update PROF_2008_STEP2 set codmun = 
...
update PROF_2008_STEP2 left join niv_dep1 
on PROF_2008_STEP2.niv_dep = niv_dep1.fonte
set PROF_2008_STEP2.niv_dep1 = niv_dep1.niv_dep1;
...
update PROF_2008_STEP2 left join esfera 
on PROF_2008_STEP2.esfera_a = esfera.esfera_a
set PROF_2008_STEP2.esfera = esfera.esfera;
...
update PROF_2008_STEP2 left join retencao 
on PROF_2008_STEP2.retencao = retencao.fonte
set PROF_2008_STEP2.retencao_2 = retencao.retencao;

select * from  PROF_2008_STEP2 left join retencao 
on PROF_2008_STEP2.retencao = retencao.fonte;
...
update PROF_2008_STEP2 left join niv_hier 
on PROF_2008_STEP2.niv_hier = niv_hier.fonte
set PROF_2008_STEP2.niv_hier_2 = niv_hier.niv_hier;


select * from  PROF_2008_STEP2 left join niv_hier  
on PROF_2008_STEP2.niv_hier = niv_hier .fonte;
