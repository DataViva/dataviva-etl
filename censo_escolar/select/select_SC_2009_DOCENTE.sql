...
select ANO_CENSO,FK_COD_DOCENTE,NUM_IDADE,TP_SEXO,TP_COR_RACA,FK_COD_MUNICIPIO_DEND,
       ...
       PK_COD_ENTIDADE,ID_DEPENDENCIA_ADM,FK_COD_AREA_OCDE_1, FK_COD_MUNICIPIO,
       ID_QUIMICA,ID_FISICA,ID_MATEMATICA,ID_BIOLOGIA,ID_CIENCIAS,ID_LINGUA_LITERAT_PORTUGUESA,
       ID_LINGUA_LITERAT_INGLES,ID_LINGUA_LITERAT_ESPANHOL,ID_LINGUA_LITERAT_INDIGENA,ID_LINGUA_LITERAT_OUTRA,
       ID_ARTES, ID_EDUCACAO_FISICA,ID_HISTORIA,ID_GEOGRAFIA,ID_FILOSOFIA,ID_ENSINO_RELIGIOSO,ID_ESTUDOS_SOCIAIS,
       ID_INFORMATICA_COMPUTACAO,ID_PROFISSIONALIZANTE,ID_DISC_ATENDIMENTO_ESPECIAIS,
       ID_DISC_DIVERSIDADE_SOCIO_CULT,ID_LIBRAS,ID_OUTRAS_DISCIPLINAS
...
if(ID_LINGUA_LITERAT_INDIGENA=1,28,
if(ID_ENSINO_RELIGIOSO=1,29,0)))))))))))))))))))))));
