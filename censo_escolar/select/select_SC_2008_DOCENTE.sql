...
drop table if exists SC_2008_DOCENTE_STEP1;
create table SC_2008_DOCENTE_STEP1 
...
from SC_2008_DOCENTE;


# Criando o step 2:

drop table if exists SC_2008_DOCENTE_STEP2;
create table SC_2008_DOCENTE_STEP2 select * from SC_2008_DOCENTE_STEP1;

# Criando a variável com o nome da disciplina ofertada pelo docente:

alter table SC_2008_DOCENTE_STEP2 add DISCIPLINA int(2);


update SC_2008_DOCENTE_STEP2 set DISCIPLINA=
if(ID_QUIMICA=1,4,
if(ID_FISICA=1,5,
...
ALTER TABLE SC_2008_DOCENTE_STEP2 DROP NUM_FUNCIONARIOS;
ALTER TABLE SC_2008_DOCENTE_STEP2 DROP DESC_SITUACAO_FUNCIONAMENTO;
ALTER TABLE SC_2008_DOCENTE_STEP2 DROP ID_ALIMENTACAO;
ALTER TABLE SC_2008_DOCENTE_STEP2 DROP ID_EDUCACAO_INDIGENA;

alter table SC_2008_DOCENTE_STEP2 add (
...
update SC_2008_DOCENTE_STEP2 left join SC_2008_ESCOLA_STEP1 
on SC_2008_DOCENTE_STEP2.PK_COD_ENTIDADE = SC_2008_ESCOLA_STEP1.PK_COD_ENTIDADE
set SC_2008_DOCENTE_STEP2.NUM_FUNCIONARIOS = SC_2008_ESCOLA_STEP1.NUM_FUNCIONARIOS;

update SC_2008_DOCENTE_STEP2 left join SC_2008_ESCOLA_STEP1 
on SC_2008_DOCENTE_STEP2.PK_COD_ENTIDADE = SC_2008_ESCOLA_STEP1.PK_COD_ENTIDADE
set SC_2008_DOCENTE_STEP2.ID_ALIMENTACAO = SC_2008_ESCOLA_STEP1.ID_ALIMENTACAO;

update SC_2008_DOCENTE_STEP2 left join SC_2008_ESCOLA_STEP1 
on SC_2008_DOCENTE_STEP2.PK_COD_ENTIDADE = SC_2008_ESCOLA_STEP1.PK_COD_ENTIDADE
set SC_2008_DOCENTE_STEP2.ID_EDUCACAO_INDIGENA = SC_2008_ESCOLA_STEP1.ID_EDUCACAO_INDIGENA;





SELECT NUM_FUNCIONARIOS,count(*) FROM SC_2008_ESCOLA_STEP1 group by NUM_FUNCIONARIOS;




select DISCIPLINA, count(*) from SC_2008_DOCENTE_STEP2 group by DISCIPLINA;



select ID_QUIMICA, count(*) from SC_2008_DOCENTE_STEP2 group by ID_QUIMICA;


select count(*) from SC_2008_DOCENTE_STEP2; 

select * from SC_2008_DOCENTE_STEP2;

select * from SC_2008_DOCENTE where  FK_COD_DOCENTE='   115002358577';
