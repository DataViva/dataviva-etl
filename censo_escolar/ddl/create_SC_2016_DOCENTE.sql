...
drop table if exists SC_2016_DOCENTE;
create table SC_2016_DOCENTE(
...
load data local infile 'Y:/Censo Escolar/2016/DADOS/DOCENTES_CO.csv'
into table SC_2016_DOCENTE
character set 'latin1'
fields terminated by '|'
lines terminated by '\n'
ignore 1 lines;

load data local infile 'Y:/Censo Escolar/2016/DADOS/DOCENTES_NORDESTE.csv'
into table SC_2016_DOCENTE
character set 'latin1'
fields terminated by '|'
lines terminated by '\n'
...
load data local infile 'Y:/Censo Escolar/2016/DADOS/DOCENTES_NORTE.csv'
into table SC_2016_DOCENTE
character set 'latin1'
fields terminated by '|'
lines terminated by '\n'
...
load data local infile 'Y:/Censo Escolar/2016/DADOS/DOCENTES_SUDESTE.csv'
into table SC_2016_DOCENTE
character set 'latin1'
fields terminated by '|'
lines terminated by '\n'
...
load data local infile 'Y:/Censo Escolar/2016/DADOS/DOCENTES_SUL.csv'
into table SC_2016_DOCENTE
character set 'latin1'
fields terminated by '|'
lines terminated by '\n'
