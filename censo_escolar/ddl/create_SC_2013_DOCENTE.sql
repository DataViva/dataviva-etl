...
drop table if exists SC_2013_DOCENTE_BLOCO;
create table SC_2013_DOCENTE_BLOCO(dados varchar(2000) not null);

load data local infile 'Y:/Censo Escolar/2013/DADOS/TS_DOCENTES_AC.txt'
into table SC_2013_DOCENTE_BLOCO
character set 'latin1'
fields terminated by '\t'
lines terminated by '\n';

load data local infile 'Y:/Censo Escolar/2013/DADOS/TS_DOCENTES_AL.txt'
into table SC_2013_DOCENTE_BLOCO
character set 'latin1'
fields terminated by '\t'
lines terminated by '\n';

load data local infile 'Y:/Censo Escolar/2013/DADOS/TS_DOCENTES_AM.txt'
into table SC_2013_DOCENTE_BLOCO
character set 'latin1'
fields terminated by '\t'
lines terminated by '\n';

load data local infile 'Y:/Censo Escolar/2013/DADOS/TS_DOCENTES_AP.txt'
into table SC_2013_DOCENTE_BLOCO
character set 'latin1'
fields terminated by '\t'
lines terminated by '\n';

load data local infile 'Y:/Censo Escolar/2013/DADOS/TS_DOCENTES_BA.txt'
into table SC_2013_DOCENTE_BLOCO
character set 'latin1'
fields terminated by '\t'
lines terminated by '\n';

load data local infile 'Y:/Censo Escolar/2013/DADOS/TS_DOCENTES_CE.txt'
into table SC_2013_DOCENTE_BLOCO
character set 'latin1'
fields terminated by '\t'
lines terminated by '\n';

load data local infile 'Y:/Censo Escolar/2013/DADOS/TS_DOCENTES_DF.txt'
into table SC_2013_DOCENTE_BLOCO
character set 'latin1'
fields terminated by '\t'
lines terminated by '\n';

load data local infile 'Y:/Censo Escolar/2013/DADOS/TS_DOCENTES_ES.txt'
into table SC_2013_DOCENTE_BLOCO
character set 'latin1'
fields terminated by '\t'
lines terminated by '\n';

load data local infile 'Y:/Censo Escolar/2013/DADOS/TS_DOCENTES_GO.txt'
into table SC_2013_DOCENTE_BLOCO
character set 'latin1'
fields terminated by '\t'
lines terminated by '\n';

load data local infile 'Y:/Censo Escolar/2013/DADOS/TS_DOCENTES_MA.txt'
into table SC_2013_DOCENTE_BLOCO
character set 'latin1'
fields terminated by '\t'
lines terminated by '\n';

load data local infile 'Y:/Censo Escolar/2013/DADOS/TS_DOCENTES_MG.txt'
into table SC_2013_DOCENTE_BLOCO
character set 'latin1'
fields terminated by '\t'
lines terminated by '\n';

load data local infile 'Y:/Censo Escolar/2013/DADOS/TS_DOCENTES_MS.txt'
into table SC_2013_DOCENTE_BLOCO
character set 'latin1'
fields terminated by '\t'
lines terminated by '\n';

load data local infile 'Y:/Censo Escolar/2013/DADOS/TS_DOCENTES_MT.txt'
into table SC_2013_DOCENTE_BLOCO
character set 'latin1'
fields terminated by '\t'
lines terminated by '\n';

load data local infile 'Y:/Censo Escolar/2013/DADOS/TS_DOCENTES_PA.txt'
into table SC_2013_DOCENTE_BLOCO
character set 'latin1'
fields terminated by '\t'
lines terminated by '\n';

load data local infile 'Y:/Censo Escolar/2013/DADOS/TS_DOCENTES_PB.txt'
into table SC_2013_DOCENTE_BLOCO
character set 'latin1'
fields terminated by '\t'
lines terminated by '\n';

load data local infile 'Y:/Censo Escolar/2013/DADOS/TS_DOCENTES_PE.txt'
into table SC_2013_DOCENTE_BLOCO
character set 'latin1'
fields terminated by '\t'
lines terminated by '\n';

load data local infile 'Y:/Censo Escolar/2013/DADOS/TS_DOCENTES_PI.txt'
into table SC_2013_DOCENTE_BLOCO
character set 'latin1'
fields terminated by '\t'
lines terminated by '\n';

load data local infile 'Y:/Censo Escolar/2013/DADOS/TS_DOCENTES_PR.txt'
into table SC_2013_DOCENTE_BLOCO
character set 'latin1'
fields terminated by '\t'
lines terminated by '\n';

load data local infile 'Y:/Censo Escolar/2013/DADOS/TS_DOCENTES_RJ.txt'
into table SC_2013_DOCENTE_BLOCO
character set 'latin1'
fields terminated by '\t'
lines terminated by '\n';

load data local infile 'Y:/Censo Escolar/2013/DADOS/TS_DOCENTES_RN.txt'
into table SC_2013_DOCENTE_BLOCO
character set 'latin1'
fields terminated by '\t'
lines terminated by '\n';

load data local infile 'Y:/Censo Escolar/2013/DADOS/TS_DOCENTES_RO.txt'
into table SC_2013_DOCENTE_BLOCO
character set 'latin1'
fields terminated by '\t'
lines terminated by '\n';

load data local infile 'Y:/Censo Escolar/2013/DADOS/TS_DOCENTES_RR.txt'
into table SC_2013_DOCENTE_BLOCO
character set 'latin1'
fields terminated by '\t'
lines terminated by '\n';

load data local infile 'Y:/Censo Escolar/2013/DADOS/TS_DOCENTES_RS.txt'
into table SC_2013_DOCENTE_BLOCO
character set 'latin1'
fields terminated by '\t'
lines terminated by '\n';

load data local infile 'Y:/Censo Escolar/2013/DADOS/TS_DOCENTES_SC.txt'
into table SC_2013_DOCENTE_BLOCO
character set 'latin1'
fields terminated by '\t'
lines terminated by '\n';

load data local infile 'Y:/Censo Escolar/2013/DADOS/TS_DOCENTES_SE.txt'
into table SC_2013_DOCENTE_BLOCO
character set 'latin1'
fields terminated by '\t'
lines terminated by '\n';

load data local infile 'Y:/Censo Escolar/2013/DADOS/TS_DOCENTES_SP.txt'
into table SC_2013_DOCENTE_BLOCO
character set 'latin1'
fields terminated by '\t'
lines terminated by '\n';

load data local infile 'Y:/Censo Escolar/2013/DADOS/TS_DOCENTES_TO.txt'
into table SC_2013_DOCENTE_BLOCO
character set 'latin1'
fields terminated by '\t'
lines terminated by '\n';

drop table if exists SC_2013_DOCENTE;
create table SC_2013_DOCENTE select 
...
from SC_2013_DOCENTE_BLOCO;

select * from SC_2013_DOCENTE;

drop table SC_2013_DOCENTE_BLOCO;
