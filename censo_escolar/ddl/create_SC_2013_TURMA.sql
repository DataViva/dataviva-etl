...
drop table if exists SC_2013_TURMA_BLOCO;
create table SC_2013_TURMA_BLOCO(dados varchar(2000) not null);

load data local infile 'Y:/Censo Escolar/2013/DADOS/TS_TURMA.txt'
into table SC_2013_TURMA_BLOCO
character set 'latin1'
fields terminated by '\t'
lines terminated by '\n';

drop table if exists SC_2013_TURMA;
create table SC_2013_TURMA select 
...
from SC_2013_TURMA_BLOCO;

select * from SC_2013_TURMA;

drop table SC_2013_TURMA_BLOCO;
