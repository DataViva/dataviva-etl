...
drop table if exists SC_2016_MATRICULA;
create table SC_2016_MATRICULA(
...
load data local infile 'Y:/Censo Escolar/2016/DADOS/MATRICULA_CO.csv'
into table SC_2016_MATRICULA
character set 'latin1'
fields terminated by '|'
lines terminated by '\n'
ignore 1 lines;

load data local infile 'Y:/Censo Escolar/2016/DADOS/MATRICULA_NORDESTE.csv'
into table SC_2016_MATRICULA
character set 'latin1'
fields terminated by '|'
lines terminated by '\n'
...
load data local infile 'Y:/Censo Escolar/2016/DADOS/MATRICULA_NORTE.csv'
into table SC_2016_MATRICULA
character set 'latin1'
fields terminated by '|'
lines terminated by '\n'
...
load data local infile 'Y:/Censo Escolar/2016/DADOS/MATRICULA_SUDESTE.csv'
into table SC_2016_MATRICULA
character set 'latin1'
fields terminated by '|'
lines terminated by '\n'
...
load data local infile 'Y:/Censo Escolar/2016/DADOS/MATRICULA_SUL.csv'
into table SC_2016_MATRICULA
character set 'latin1'
fields terminated by '|'
lines terminated by '\n'
