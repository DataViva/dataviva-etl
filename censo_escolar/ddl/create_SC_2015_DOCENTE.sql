...
drop table if exists SC_2015_DOCENTE;
create table SC_2015_DOCENTE(
...
IN_POSSUI_NEC_ESPECIAL varchar(2),
...
NO_IES_CURSO_1 varchar(100),
CO_IES_1 varchar(15),
TP_SITUACAO_CURSO_2 varchar(2),
CO_AREA_CURSO_2 varchar(3),
...
NO_IES_CURSO_2 varchar(100),
CO_IES_2 varchar(15),
TP_SITUACAO_CURSO_3 varchar(2),
CO_AREA_CURSO_3 varchar(3),
...
load data local infile 'Y:/Censo Escolar/2015/DADOS/DOCENTES_CO.csv'
into table SC_2015_DOCENTE
character set 'latin1'
fields terminated by '|'
lines terminated by '\n'
ignore 1 lines;

load data local infile 'Y:/Censo Escolar/2015/DADOS/DOCENTES_NORDESTE.csv'
into table SC_2015_DOCENTE
character set 'latin1'
fields terminated by '|'
lines terminated by '\n'
...
load data local infile 'Y:/Censo Escolar/2015/DADOS/DOCENTES_NORTE.csv'
into table SC_2015_DOCENTE
character set 'latin1'
fields terminated by '|'
lines terminated by '\n'
...
load data local infile 'Y:/Censo Escolar/2015/DADOS/DOCENTES_SUDESTE.csv'
into table SC_2015_DOCENTE
character set 'latin1'
fields terminated by '|'
lines terminated by '\n'
...
load data local infile 'Y:/Censo Escolar/2015/DADOS/DOCENTES_SUL.csv'
into table SC_2015_DOCENTE
character set 'latin1'
fields terminated by '|'
lines terminated by '\n'
