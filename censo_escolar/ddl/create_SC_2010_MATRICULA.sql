...
drop table if exists SC_2010_MATRICULA_BLOCO;
create table SC_2010_MATRICULA_BLOCO(dados varchar(2000) not null);

load data local infile 'Y:/Censo Escolar/2010/DADOS/TS_MATRICULA_AC.txt'
into table SC_2010_MATRICULA_BLOCO
character set 'latin1'
fields terminated by '\t'
lines terminated by '\n';

load data local infile 'Y:/Censo Escolar/2010/DADOS/TS_MATRICULA_AL.txt'
into table SC_2010_MATRICULA_BLOCO
character set 'latin1'
fields terminated by '\t'
lines terminated by '\n';

load data local infile 'Y:/Censo Escolar/2010/DADOS/TS_MATRICULA_AM.txt'
into table SC_2010_MATRICULA_BLOCO
character set 'latin1'
fields terminated by '\t'
lines terminated by '\n';

load data local infile 'Y:/Censo Escolar/2010/DADOS/TS_MATRICULA_AP.txt'
into table SC_2010_MATRICULA_BLOCO
character set 'latin1'
fields terminated by '\t'
lines terminated by '\n';

load data local infile 'Y:/Censo Escolar/2010/DADOS/TS_MATRICULA_BA.txt'
into table SC_2010_MATRICULA_BLOCO
character set 'latin1'
fields terminated by '\t'
lines terminated by '\n';

load data local infile 'Y:/Censo Escolar/2010/DADOS/TS_MATRICULA_CE.txt'
into table SC_2010_MATRICULA_BLOCO
character set 'latin1'
fields terminated by '\t'
lines terminated by '\n';

load data local infile 'Y:/Censo Escolar/2010/DADOS/TS_MATRICULA_DF.txt'
into table SC_2010_MATRICULA_BLOCO
character set 'latin1'
fields terminated by '\t'
lines terminated by '\n';

load data local infile 'Y:/Censo Escolar/2010/DADOS/TS_MATRICULA_ES.txt'
into table SC_2010_MATRICULA_BLOCO
character set 'latin1'
fields terminated by '\t'
lines terminated by '\n';

load data local infile 'Y:/Censo Escolar/2010/DADOS/TS_MATRICULA_GO.txt'
into table SC_2010_MATRICULA_BLOCO
character set 'latin1'
fields terminated by '\t'
lines terminated by '\n';

load data local infile 'Y:/Censo Escolar/2010/DADOS/TS_MATRICULA_MA.txt'
into table SC_2010_MATRICULA_BLOCO
character set 'latin1'
fields terminated by '\t'
lines terminated by '\n';

load data local infile 'Y:/Censo Escolar/2010/DADOS/TS_MATRICULA_MG.txt'
into table SC_2010_MATRICULA_BLOCO
character set 'latin1'
fields terminated by '\t'
lines terminated by '\n';

load data local infile 'Y:/Censo Escolar/2010/DADOS/TS_MATRICULA_MS.txt'
into table SC_2010_MATRICULA_BLOCO
character set 'latin1'
fields terminated by '\t'
lines terminated by '\n';

load data local infile 'Y:/Censo Escolar/2010/DADOS/TS_MATRICULA_MT.txt'
into table SC_2010_MATRICULA_BLOCO
character set 'latin1'
fields terminated by '\t'
lines terminated by '\n';

load data local infile 'Y:/Censo Escolar/2010/DADOS/TS_MATRICULA_PA.txt'
into table SC_2010_MATRICULA_BLOCO
character set 'latin1'
fields terminated by '\t'
lines terminated by '\n';

load data local infile 'Y:/Censo Escolar/2010/DADOS/TS_MATRICULA_PB.txt'
into table SC_2010_MATRICULA_BLOCO
character set 'latin1'
fields terminated by '\t'
lines terminated by '\n';

load data local infile 'Y:/Censo Escolar/2010/DADOS/TS_MATRICULA_PE.txt'
into table SC_2010_MATRICULA_BLOCO
character set 'latin1'
fields terminated by '\t'
lines terminated by '\n';

load data local infile 'Y:/Censo Escolar/2010/DADOS/TS_MATRICULA_PI.txt'
into table SC_2010_MATRICULA_BLOCO
character set 'latin1'
fields terminated by '\t'
lines terminated by '\n';

load data local infile 'Y:/Censo Escolar/2010/DADOS/TS_MATRICULA_PR.txt'
into table SC_2010_MATRICULA_BLOCO
character set 'latin1'
fields terminated by '\t'
lines terminated by '\n';

load data local infile 'Y:/Censo Escolar/2010/DADOS/TS_MATRICULA_RJ.txt'
into table SC_2010_MATRICULA_BLOCO
character set 'latin1'
fields terminated by '\t'
lines terminated by '\n';

load data local infile 'Y:/Censo Escolar/2010/DADOS/TS_MATRICULA_RN.txt'
into table SC_2010_MATRICULA_BLOCO
character set 'latin1'
fields terminated by '\t'
lines terminated by '\n';

load data local infile 'Y:/Censo Escolar/2010/DADOS/TS_MATRICULA_RO.txt'
into table SC_2010_MATRICULA_BLOCO
character set 'latin1'
fields terminated by '\t'
lines terminated by '\n';

load data local infile 'Y:/Censo Escolar/2010/DADOS/TS_MATRICULA_RR.txt'
into table SC_2010_MATRICULA_BLOCO
character set 'latin1'
fields terminated by '\t'
lines terminated by '\n';

load data local infile 'Y:/Censo Escolar/2010/DADOS/TS_MATRICULA_RS.txt'
into table SC_2010_MATRICULA_BLOCO
character set 'latin1'
fields terminated by '\t'
lines terminated by '\n';

load data local infile 'Y:/Censo Escolar/2010/DADOS/TS_MATRICULA_SC.txt'
into table SC_2010_MATRICULA_BLOCO
character set 'latin1'
fields terminated by '\t'
lines terminated by '\n';

load data local infile 'Y:/Censo Escolar/2010/DADOS/TS_MATRICULA_SE.txt'
into table SC_2010_MATRICULA_BLOCO
character set 'latin1'
fields terminated by '\t'
lines terminated by '\n';

load data local infile 'Y:/Censo Escolar/2010/DADOS/TS_MATRICULA_SP.txt'
into table SC_2010_MATRICULA_BLOCO
character set 'latin1'
fields terminated by '\t'
lines terminated by '\n';

load data local infile 'Y:/Censo Escolar/2010/DADOS/TS_MATRICULA_TO.txt'
into table SC_2010_MATRICULA_BLOCO
character set 'latin1'
fields terminated by '\t'
lines terminated by '\n';

drop table if exists SC_2010_MATRICULA;
create table SC_2010_MATRICULA select 
...
from SC_2010_MATRICULA_BLOCO;

select * from SC_2010_MATRICULA;

DROP TABLE SC_2010_MATRICULA_BLOCO;
