...
drop table if exists SC_2015_TURMA;
create table SC_2015_TURMA(
...
load data local infile 'Y:/Censo Escolar/2015/DADOS/TURMAS.csv'
into table SC_2015_TURMA
character set 'latin1'
fields terminated by '|'
lines terminated by '\n'
ignore 1 lines;

select * from SC_2015_TURMA;
